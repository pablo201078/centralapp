...
List<Container> _buildFilasInfo(List<Map<String, String>> lista) {
  List<Container> filas = List<Container>();
      ...
      Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.only(
              topLeft: Radius.circular(inicio ? 20 : 0),//si es la primera fila la hago redondeada arriba
              topRight: Radius.circular(inicio ? 20 : 0),
              bottomLeft: Radius.circular(fin ? 20 : 0),
              bottomRight: Radius.circular(fin ? 20 : 0)),//si es la ultima la hago redondeada abajo
        ),
        child: Padding(
